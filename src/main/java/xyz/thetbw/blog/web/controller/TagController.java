...
public class TagController extends BaseController {
    ...
    public String tag(Model model){
        ...
        model.addAttribute(ModelKey.TAG_LIST,tags);
        return this.render(ConstValue.VIEW_TAG);
    }
    ...
    public String tag_articles(@PathVariable int tag_id, @RequestParam(defaultValue = "1") int page,Model model){
        ...
        model.addAttribute(ModelKey.TAG_ARTICLES,articles);
        model.addAttribute(ModelKey.PAGINATION,pageHelper.genPaginations("/tag",hashMap,"page"));
        model.addAttribute(ModelKey.NOW_TAG,tag);
        return this.render(ConstValue.VIEW_TAG);
    }
}
